<div class="contenido">
    ...
    <div class="model-box-default">
        <h2>Editar ofertas de viaje</h2><br>

        <form id="trip" action="index.php?controller=trip&action=editTrip&id=<?php echo $dataToView['data']['idRoute']; ?>"" method="POST" >

        <div class="form-section active" id="section1">
                <label for="title">Título</label>
                <input class="input-box" type="text" id="title" name="title" title="Ingrese un título" maxlength="45"
                    placeholder="Ingrese un título" value="<?php echo $dataToView['data']['title']; ?>">
                ...
                <input class="input-box" type="text" id="departureLocation" name="departureLocation"
                    title="Ingrese el lugar de salida" maxlength="45" 
                    placeholder="Ingrese el lugar de salida" value="<?php echo $dataToView['data']['departureLocation']; ?>">
                ...
                <input class="input-box" type="date" id="departureDate" name="departureDate"
                    title="Selecciona la fecha de salida" value="<?php echo $dataToView['data']['departureDate']; ?>">
                ...
                <input class="input-box" type="time" id="departureTime" name="departureTime"
                    title="Selecciona la hora de salida" value="<?php echo $dataToView['data']['departureTime']; ?>">
        ...
        <div class="form-section" id="section2">
                ...
                <input class="input-box" type="date" id="returnDate" name="returnDate"
                    title="Selecciona la fecha de regreso" value="<?php echo $dataToView['data']['returnDate']; ?>">
                ...
                <input class="input-box" type="time" id="returnTime" name="returnTime"
                    title="Selecciona la hora de regreso" value="<?php echo $dataToView['data']['returnTime']; ?>">
                ...
                <input class="input-box" type="text" id="numberSlots" name="numberSlots"
                    title="Ingrese la cantidad de cupos" maxlength="10" 
                    placeholder="Ingrese la cantidad de cupos" value="<?php echo $dataToView['data']['numberSlots']; ?>">
                ...
                <input class="input-box" type="text" id="price" name="price" title="Ingrese el costo del viaje"
                    maxlength="11" placeholder="Ingrese el costo del viaje" value="<?php echo $dataToView['data']['price']; ?>">
        ...
        <div class="form-section" id="section2">
            <?php 
              require_once("view/trip/editTrip2.php");
            ?>
                <button class="button-Rev" type="button" onclick="previousSection()">Anterior</button>
              <!--   <button class="button-Rev" type="button" onclick="nextSection()">Siguiente</button> -->
        </div>
         <!--    <div class="form-section" id="section2">
                <?php 
               // require_once("view/trip/addTrip3.php");
                ?>
                <button class="button-Rev" type="button" onclick="previousSection()">Anterior</button>
        ...
        <a href="index.php?controller=trip&action=list" title="Cancelar"><button
